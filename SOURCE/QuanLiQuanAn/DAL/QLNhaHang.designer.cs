...
namespace DAL
{
    ...
    partial void DeleteFoodCategory(FoodCategory instance);
		...
		public QLNhaHangDataContext() : 
				base(global::DAL.Properties.Settings.Default.QUANLYNHAHANGConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnidChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AccountType_Account", Storage="_AccountType", ThisKey="id", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnnameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AccountType_Account", Storage="_Accounts", ThisKey="id", OtherKey="id")]
